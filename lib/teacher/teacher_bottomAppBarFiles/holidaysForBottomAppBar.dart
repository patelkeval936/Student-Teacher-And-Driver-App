...
class HolidaysForBottomAppBar extends StatefulWidget {
  @override
  _HolidaysForBottomAppBarState createState() => _HolidaysForBottomAppBarState();
}

class _HolidaysForBottomAppBarState extends State<HolidaysForBottomAppBar> {
            ...
            child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                Container(
                    height: height * 0.12,
                    width: width * 0.55,
                    child: Center(child: Text('${holidays[i]['title']}',
