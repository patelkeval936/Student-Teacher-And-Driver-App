...
class ProfilePageContainer extends StatefulWidget {
  ...
  const ProfilePageContainer({Key key, this.studentId, this.studentClass, this.isInitialized})
      : super(key: key);
  @override
...
class _ProfilePageContainerState extends State<ProfilePageContainer> {
 ...
 //   await PermissionHandler().requestPermissions([PermissionGroup.storage]);
  ...
  Widget build(BuildContext context) {
    ...
    // Widget cardMaker(String title){
    //   return Card(
    //       elevation: 3,
    //       shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(20)),
    //       child:  Container(
    //         height: height * 0.12,width: width * 0.47,
    //         decoration: BoxDecoration(
    //           borderRadius: BorderRadius.circular(20),
    //           gradient: LinearGradient(
    //             begin: Alignment.centerLeft,
    //             end: Alignment.centerRight, // 10% of the width, so there are ten blinds.
    //             colors: [Color(0xFF735ede),Color(0xFF7a82d9)], // whitish to gray
