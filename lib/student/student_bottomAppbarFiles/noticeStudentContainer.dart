...
class NoticeStudentContainer extends StatefulWidget {
  @override
  _NoticeStudentContainerState createState() => _NoticeStudentContainerState();
}

class _NoticeStudentContainerState extends State<NoticeStudentContainer> {
